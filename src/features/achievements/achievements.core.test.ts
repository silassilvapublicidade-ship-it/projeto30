...
import { getAchievementProgress, getHalfwayTarget, initialAchievementSlugs } from "./achievements.core";

describe("getHalfwayTarget", () => {
...
describe("initialAchievementSlugs", () => {
