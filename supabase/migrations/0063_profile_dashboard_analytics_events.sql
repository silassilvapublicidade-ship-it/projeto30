-- Dashboard de Evolucao Pessoal (Perfil) - Parte 3/3. Mesma tecnica de 0042/
-- 0052 (drop + recreate do CHECK, create or replace do corpo de
-- record_analytics_event - assinatura inalterada). Exatamente os 5 eventos
-- pedidos, nenhum a mais - nenhum dado pessoal no metadata.
